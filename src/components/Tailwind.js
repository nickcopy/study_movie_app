function Tailwind() {
  return (
    <div className="bg-white border-red-600 p-5">
      <div className="flex justify-between">
        <duv className="flex justify-start">
          <div className="text-3xl ml-4 ">더보기</div>
        </duv>
      ...
      <div className=" flex">
        ...
        <div className="flex items-center justify-end">
          <div className="  border-[2px] rounded-[40%] w-16 flex justify-center">
            MY
          </div>
          <div className=" border-[2px] rounded-[40%] w-16 flex justify-center">
            🎟10
      ...
      {/* 여기까지 프로필 */}
      <div className="w-[690px] h-[35px] bg-gray-300 rounded-[6px] flex items-center">
        <div className=" ml-4">
          <img
            className="w-[5px]"
